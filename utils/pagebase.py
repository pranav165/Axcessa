...
class PageBase(object):
    ...
    def evergy_sign_in(self, xpat):
        submit_button = self._driver.find_elements_by_xpath(xpat)
    ...
    def select_list_option_by_index(self, locator, text):
    ...
    def switch_to_frame(self, frame):
        """
        switches the driver to the iFrame
        :frame - frame element or locator
        """
    ...
    def is_element_displayed(self, locator, timeout=1):
        ...
        try:
            ...
            raise Exception("Could Not Verify Element Display {} due to error {}".format(locator, str(e)))
        return True
    ...
    def get_screenshot_as_png(self, path):
